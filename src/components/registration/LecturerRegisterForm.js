...
class LecturerRegisterForm extends Component {
  ...
  validate = () => {
    ...
    if (data.Lecturer_Name === "") errors.Lecturer_Name = "Lecturer_Name can not be blank.";
    if (data.Lecturer_email === "") errors.Lecturer_email = "Lecturer Email can not be blank.";
  ...
  handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      console.log(data);
      //Call an api here
      axios.post("http://localhost:3001/register/lecturer", data).then(
          res =>{
            console.log(res)
          }
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              <FormGroup>
                <div className="col-sm-12">
                  ...
                  <Input
                      ...
                      invalid={!!errors.Lecturer_Name}
                      name="Lecturer_Name"
                      onChange={this.handleChange}
                  />
                  <FormFeedback>{errors.Lecturer_Name}</FormFeedback>
                </div>
              </FormGroup>
              ...
              <FormGroup>
                <div className="col-sm-12">
                  ...
                  <Input
                      value={data.Lecturer_email}
                      invalid={!!errors.email}
                      name="Lecturer_email"
                      onChange={this.handleChange}
                  />
                  <FormFeedback>{errors.Lecturer_email}</FormFeedback>
                </div>
              </FormGroup>
